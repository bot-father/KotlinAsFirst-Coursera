...
class Tests {
    ...
    fun factorize() {
        ...
        assertEquals(listOf(2, 2, 2, 2, 2, 2, 2, 2, 2, 2), factorize(1024))
        assertEquals(listOf(3, 3, 3, 13), factorize(351))
        assertEquals(listOf(2, 2, 2, 2, 2, 2, 3, 5, 5, 5), factorize(24000))
    ...
    fun factorizeToString() {
        ...
        assertEquals("2*2*3*3*5*19", factorizeToString(3420))
    ...
    @Tag("Hard")
    fun roman() {
        assertEquals("MD", roman(1500))
        assertEquals("MCCXXXIV", roman(1234))
